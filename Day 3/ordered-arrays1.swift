...
scores.append(100) // adds data to the array
scores.append(80)
scores.append(85)
print(scores[1])
...
print(bondMovies.contains("Frozen")) // prints out false

let cities = ["London", "Tokyo", "Rome", "Budapest"]
print(cities.sorted())  // sorts out the array in assending order

let presidents = ["Bush", "Obama", "Trump", "Biden"]
let reversedPresidents = presidents.reversed() // it doesnt rearrange items, but instead just remembers to itself that the items are to be reversed.
